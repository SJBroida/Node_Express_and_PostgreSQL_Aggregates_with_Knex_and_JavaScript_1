...
async function averageRating(req, res, next) {
  // your solution here
  const theAverage = await service.averageRating();
  theAverage.average_rating = Number(theAverage.average_rating)
  res.json({ data: theAverage });
}
...
async function count(req, res, next) {
  // your solution here
  const theData = await service.count();
  theData.count = parseInt(theData.count);
  res.json({ data: theData });
}
...
async function readHighestRating(req, res, next) {
  // your solution here
  //const theData = await service.readHighestRating();
  //theData.count = parseInt(theData.count);
  res.json({ data: await service.readHighestRating() });
}
